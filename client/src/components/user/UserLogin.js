...
const UserLogin = ({ onShowRegister }) => {
        ...
        >
          ...
          <div className="text-center">
            <motion.button
              ...
              className="text-red-400 hover:text-red-300 flex items-center justify-center mx-auto transition-colors duration-300 text-xs sm:text-sm"
          ...
          >
            ...
            <p className="text-xs text-gray-300 leading-relaxed">
              <strong className="text-white">Email:</strong> john.doe@example.com<br />
